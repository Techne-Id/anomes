      ...
      <div class="row align-items-center justify-content-center mt-5" style='min-height: 80vh'>
        <div class="container shadow p-3 bg-yellow">
          <div class="col-md-12 mt-2">
            ...
            <p>Daftar bla bla bla bla</p>
            <form action="">
              <input type="text" name="" id="" placeholder="Nama Kamu" class="form-control" style="margin: .5rem 0 .5rem 0; border-left: 0; border-top: 0; border-right: 0; background-color: #FCFAF5; border-radius: .25rem;">
              ...
              <button type="submit" class="btn btn-light text-blue mt-3" style="font-family: 'Montserrat'; font-weight: bold; width: 100%;">Daftar</button>
